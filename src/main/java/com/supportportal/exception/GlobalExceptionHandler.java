...
public class GlobalExceptionHandler implements ErrorController {
    ...
    private static final String METHOD_IS_NOT_ALLOWED = "This request method is not allowed on this endpoint. Please send %s method.";
    ...
    public ResponseEntity<HttpResponse> notFound404() {
        return createHttpResponse(NOT_FOUND, "There is no mapping for this URL HA HA HA");
    }
