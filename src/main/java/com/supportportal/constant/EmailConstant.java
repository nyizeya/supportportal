...
public class EmailConstant {
    ...
    public static final String USERNAME = "mlbbx2001@gmail.com";
    public static final String PASSWORD = "1738Lover";
    public static final String FROM_EAMIL = "mlbbx2001@gmail.com";
